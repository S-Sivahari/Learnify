...
import type { UserProfile } from '@/services/studyGroupsService';
    ...
    <div className="relative min-h-screen overflow-hidden bg-black">
      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        <div className="grid gap-6 lg:grid-cols-[2fr_1fr]">
          {/* Timer */}
          <Card className="border border-slate-800 bg-zinc-950/50 backdrop-blur-sm rounded-2xl shadow-xl">
            <CardHeader className="border-b border-[#DAFD78]/20">
              <CardTitle className="text-2xl font-black uppercase text-[#DAFD78]"><TranslatedText text="Pomodoro Timer" /></CardTitle>
            ...
            <CardContent className="flex flex-col items-center pt-8">
              ...
              <div className="relative mb-8 h-64 w-64 shadow-primary rounded-full">
                <svg className="h-full w-full -rotate-90 transform">
                  ...
                  <circle
                    ...
                    className="text-[#DAFD78] transition-all duration-1000"
                    strokeLinecap="round"
                  />
                </svg>
              ...
              <div className="flex gap-4">
                <Button size="lg" onClick={toggleTimer} className="min-w-32 bg-[#DAFD78] hover:bg-[#DAFD78]/90 text-black font-black">
                  {isRunning ? (
                    <>
          ...
          <div className="space-y-6">
            <Card className="border border-slate-800 rounded-2xl shadow-xl bg-zinc-950">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-2xl font-black uppercase text-[#DAFD78]">
                ...
                {soundOptions.map((option) => {
                  ...
                  return (
                    <Button
                      ...
                      className={`w-full justify-start border border-[#DAFD78]/30 font-bold ${isActive
                        ? 'bg-[#DAFD78] text-black shadow-primary'
                        : 'text-[#DAFD78] hover:bg-[#DAFD78] hover:text-black'
                        }`}
            ...
            <Card className="border border-slate-800 rounded-2xl shadow-xl bg-zinc-950">
              <CardHeader>
                <CardTitle className="text-2xl font-black uppercase text-[#BF5AF2]"><TranslatedText text="Today's Stats" /></CardTitle>
              </CardHeader>
            ...
            <Card className="border border-slate-800 rounded-2xl shadow-xl bg-zinc-950">
              <CardHeader>
                <CardTitle className="text-2xl font-black uppercase text-[#DAFD78]"><TranslatedText text="Pro Tips" /></CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="border border-slate-800 rounded-2xl shadow-xl bg-zinc-950">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-2xl font-black uppercase text-[#BF5AF2]">
                    ...
                    {onlineFriends.slice(0, 4).map((friend) => (
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-sm font-semibold text-white">{friend.display_name || friend.username}</span>
                        </div>
